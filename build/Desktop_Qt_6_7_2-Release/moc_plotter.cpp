...
void Plotter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->mudaX((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->mudaY((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 2: _t->mudaAmp((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->mudaFreq((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->mudaVel((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Plotter::mudaX; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Plotter::*)(int );
            if (_t _q_method = &Plotter::mudaY; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
